...
function main() {
  ...
  // --fresh flag: wipe auto-sourced tools before re-inserting
  if (process.argv.includes('--fresh')) {
    lines.push("")
    lines.push("-- WARNING: --fresh mode — clearing all auto-sourced tools")
    lines.push("DELETE FROM tool_tags WHERE tool_id IN (SELECT id FROM tools WHERE data_source IN ('futurepedia'));")
    lines.push("DELETE FROM tools WHERE data_source IN ('futurepedia');")
  }
