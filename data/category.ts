export const CATEGORY_ARRAY = [
	...
	},
	{
		...
		"subcategories": [
			...
			{
				"id": "study-planning",
				"title": "Study Planning & Notes",
				"keywords": [
					"ai study planner",
					"ai lecture notes tool"
				]
			},
			{
